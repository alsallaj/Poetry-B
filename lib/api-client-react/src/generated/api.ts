 ...
 */
export const getGetLevelUrl = (levelNumber: number) => {
  return `/api/levels/${levelNumber}`;
};
...
export const getLevel = async (
  ...
  return customFetch<LevelDetail>(getGetLevelUrl(levelNumber), {
    ...options,
    method: "GET",
  });
};

export const getGetLevelQueryKey = (levelNumber: number) => {
  return [`/api/levels/${levelNumber}`] as const;
};
...
>(
  ...
  const queryKey = queryOptions?.queryKey ?? getGetLevelQueryKey(levelNumber);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getLevel>>> = ({
    signal,
  }) => getLevel(levelNumber, { signal, ...requestOptions });
...
export type GetLevelQueryResult = NonNullable<
  Awaited<ReturnType<typeof getLevel>>
>;
export type GetLevelQueryError = ErrorType<ApiError>;
...
>(
  ...
  const queryOptions = getGetLevelQueryOptions(levelNumber, options);
 ...
 */
export const getCompleteLevelUrl = () => {
  return `/api/progress/complete-level`;
};
...
export const completeLevel = async (
  ...
  return customFetch<UserProgress>(getCompleteLevelUrl(), {
    ...options,
    method: "POST",
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<CompleteLevelBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return completeLevel(data, requestOptions);
  };
 ...
 */
export const getStartLevelSessionUrl = (levelNumber: number) => {
  return `/api/learning/start-level/${levelNumber}`;
};

export const startLevelSession = async (
  levelNumber: number,
  options?: RequestInit,
): Promise<OpenaiConversation> => {
  return customFetch<OpenaiConversation>(getStartLevelSessionUrl(levelNumber), {
    ...options,
    method: "POST",
  });
};

export const getStartLevelSessionMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof startLevelSession>>,
    TError,
    { levelNumber: number },
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = ["startLevelSession"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return startLevelSession(levelNumber, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type StartLevelSessionMutationResult = NonNullable<
  Awaited<ReturnType<typeof startLevelSession>>
>;

export type StartLevelSessionMutationError = ErrorType<unknown>;

/**
 * @summary Start a learning session for a level (creates a conversation)
 */
export const useStartLevelSession = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getStartLevelSessionMutationOptions(options));
};
